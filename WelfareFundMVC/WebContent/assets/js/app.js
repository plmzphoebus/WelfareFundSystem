angular.module('myApp', []).controller('allMemberCtrl', function ($scope, MemberService) {
    ...
    ReceiveWelfareService.listAllRecieveWelfare(findGetParameter("id")).then(function (response) {
        $scope.receiveWelfares = response;
    })
